...
func TestSchemaDigestsArePinned(t *testing.T) {
	for _, pin := range []struct {
		...
		{"current", schemaStatements, "0c290c20fe3a7c775ea016155a37b5eda2843567001f32dd9567c2d691a0cfc7"},
