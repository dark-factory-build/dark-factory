...
func TestV24MigrationPreservesSourceProofWithoutInventingGitHubID(t *testing.T) {
	...
	for _, statement := range []string{"DROP TABLE task_attachments", "DROP TABLE intake_acceptance_reviews", "DROP TABLE intake_source_priorities", "DROP TABLE intake_legacy_suppressions", "DROP TABLE intake_legacy_migrations"} {
