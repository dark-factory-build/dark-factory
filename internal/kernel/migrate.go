...
// v13SchemaStatements is the exact schema before retained terminal diagnostics.
...
// migrateV13Transaction adds the bounded retained terminal diagnostic table.
func migrateV13Transaction(ctx context.Context, connection *sql.Conn) error {
	...
	if _, err := connection.ExecContext(ctx, target["terminal_diagnostics"].sql); err != nil {
