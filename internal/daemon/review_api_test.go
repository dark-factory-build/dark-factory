...
func TestReviewPRUsesDaemonOperationAndReturnsOperationID(t *testing.T) {
	...
	got, err := daemon.reviewPR(context.Background(), kernel.ProjectID{}, api.ReviewRequest{Repository: "team/repo", PullNumber: 7, Head: "a" + "000000000000000000000000000000000000000", Base: "b" + "000000000000000000000000000000000000000", BaseRef: "main", Body: "body", Provider: "codex"})
	if err != nil || got != want {
