...
func TestManifestMatchesImplementedRegistry(t *testing.T) {
	...
	if manifest.Name != "dark-factory/browser" || len(manifest.Control) != 77 || len(manifest.Terminal.Opcodes) != 2 {
