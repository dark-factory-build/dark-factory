...
var providerEnvironmentNames = []string{
	...
	"DARK_FACTORY_MAINTAINER_BRIDGE",
	"CODEX_HOME",
...
func TestPrepareExecSpecAcceptsOnlyClosedProviderEnvironmentNames(t *testing.T) {
	...
	forbidden := []string{
		...
		"DARK_FACTORY_HOME", "DARK_FACTORY_RUN_ID", "DARK_FACTORY_TASK_ID", "DARK_FACTORY_FACTORYCTL_PATH", "DARK_FACTORY_FACTORYCTL_HELPER", "DARK_FACTORY_MAINTAINER_BRIDGE_HELPER", "ARBITRARY",
	}
