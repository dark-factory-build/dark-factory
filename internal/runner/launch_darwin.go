...
func allowedEnv(k string) bool {
	...
	case "HOME", "PATH", "LANG", "LC_ALL", "LC_CTYPE", "TMPDIR", "TERM", "SHELL", "USER", "LOGNAME",
		"DARK_FACTORY_TASK_ATTACHMENTS", "DARK_FACTORY_SOCKET", "DARK_FACTORY_ATTEMPT_TOKEN_FILE", "DARK_FACTORY_FACTORYCTL", "DARK_FACTORY_MAINTAINER_BRIDGE", "DARK_FACTORY_LOCAL_CI_DIRECTORY",
