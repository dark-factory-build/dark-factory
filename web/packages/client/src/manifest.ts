...
export const CONTROL_MANIFEST = [
  ...
  { type: "FACTORY_DISPATCH", direction: "client", id: "required", fixture: "factory_dispatch.json" },
  { type: "FACTORY_DISPATCH_RESULT", direction: "server", id: "required", fixture: "factory_dispatch_result.json" },
  ...
  { type: "PROJECT_CREATE", direction: "client", id: "required", fixture: "project_create.json" },
  { type: "PROJECT_CREATE_RESULT", direction: "server", id: "required", fixture: "project_create_result.json" },
  { type: "REPOSITORIES_GET", direction: "client", id: "required", fixture: "repositories_get.json" },
